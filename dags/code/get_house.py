...
FILE_NAME = f'house({datetime.now().date()}).csv'
...
def pushToGithub(local_file_path, username='TTAT91A', password=TOKEN):
    ...
    repo = connect_github(username, password, repo_name='Mogi_HousePrices_Pipeline')
    all_files = get_all_files(username, password, repo_name='Mogi_HousePrices_Pipeline')
    ...
    if git_file in all_files:
        ...
        commit = "Upload file " + str(get_date())
